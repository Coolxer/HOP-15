...
const int NUMBER_OF_STEPS_PER_REVOLUTION = 200;
...
const double NUMBER_OF_STEPS_PER_MM = 14.63116457257362;

const double STEPS_FOR_ONE_DEGREE = NUMBER_OF_STEPS_PER_REVOLUTION * MICROPSTEPPING / 360.0;
