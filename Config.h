...
/***************************** TABLE MOTOR ****************************************/
const double TABLE_BIG_GEAR_DIAMETER = 99;//87;
const double TABLE_SMALL_GEAR_DIAMETER = 15.5;//16;//16.5(real size)//13.8;//14;//14.1;//14.13;//14.15;//14.18;//14.2;//14;//14.5;//15;//16;//16.2;//16.42;
